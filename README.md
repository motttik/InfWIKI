...
| Модель | Размер файла | Параметры | Мин. VRAM | Рек. VRAM | Скорость | Качество RU | Описание |
|--------|-------------|-----------|-----------|-----------|----------|-------------|----------|
| **deepseek-r1:1.5b** | 1.1 GB | 1.5B | 2 GB | 4 GB | ⚡⚡⚡⚡ | ⭐⭐⭐ | Быстрая reasoning модель (Qwen-2.5 base) |
| **llama3.2:1b** | 1.3 GB | 1B | 2 GB | 4 GB | ⚡⚡⚡⚡ | ⭐⭐ | Самая быстрая, базовое качество |
| **llama3.2:3b** | 2.0 GB | 3B | 4 GB | 6 GB | ⚡⚡⚡ | ⭐⭐⭐ | Баланс для слабых GPU |
| **qwen2.5:1.5b** | 986 MB | 1.5B | 2 GB | 4 GB | ⚡⚡⚡⚡ | ⭐⭐⭐ | Компактная с поддержкой RU |
| **qwen2.5:7b** | 4.7 GB | 7B | 6 GB | 8 GB | ⚡⚡ | ⭐⭐⭐⭐ | Отличная поддержка ru/en |
| **deepseek-r1:7b** | 4.7 GB | 7B | 6 GB | 8 GB | ⚡⚡ | ⭐⭐⭐⭐ | Reasoning модель (Qwen-2.5 base) |
| **deepseek-r1:8b** | 5.2 GB | 8B | 6 GB | 8 GB | ⚡⚡ | ⭐⭐⭐⭐ | Reasoning модель (Llama3.1 base) |
| **qwen2.5:14b** | 9.0 GB | 14B | 10 GB | 12 GB | ⚡ | ⭐⭐⭐⭐⭐ | Высокое качество, русский язык |
| **deepseek-r1:14b** | 9.0 GB | 14B | 12 GB | 16 GB | ⚡ | ⭐⭐⭐⭐⭐ | Премиум reasoning (Qwen-2.5 base) |

#### Формула расчёта VRAM

Ollama использует 4-битное квантование по умолчанию:

| Точность | Формула | Пример для 8B |
|----------|---------|---------------|
| **Q4_K_M (default)** | Параметры × 0.7 байта | 8B × 0.7 ≈ **5.6 GB** |
| **INT8** | Параметры × 1 байт | 8B × 1 = **8 GB** |
| **FP16** | Параметры × 2 байта | 8B × 2 = **16 GB** |

> 💡 **Рекомендация для русского языка:**
> - **Топ выбор:** `qwen2.5:14b` или `deepseek-r1:14b` — наилучшее качество для энциклопедических статей
> - **Баланс:** `qwen2.5:7b` или `deepseek-r1:7b` — отличное качество при 6-8 GB VRAM
> - **Бюджетный:** `llama3.2:3b` или `qwen2.5:1.5b` — для систем с 4-6 GB VRAM
