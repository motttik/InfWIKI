...
| Модель | Размер | VRAM (мин) | VRAM (рек) | Скорость | Качество | Описание |
|--------|--------|------------|------------|----------|----------|----------|
| **llama3.2:3b** | 2 GB | 4 GB | 6 GB | ⚡⚡⚡ | ⭐⭐ | Быстрая, для слабых GPU |
| **llama3.2:1b** | 1 GB | 2 GB | 4 GB | ⚡⚡⚡⚡ | ⭐ | Самая быстрая, базовое качество |
...
| **gemma2:9b** | 5 GB | 8 GB | 10 GB | ⚡⚡ | ⭐⭐⭐ | Хорошая для технических тем |
| **phi3:mini** | 2 GB | 4 GB | 6 GB | ⚡⚡⚡ | ⭐⭐ | Компактная от Microsoft |

> 💡 **Рекомендация для русского языка:** Используйте `qwen2.5:7b` или `qwen2.5:14b` — они показывают наилучшие результаты с кириллицей.
